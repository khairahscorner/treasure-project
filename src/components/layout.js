      ...
      <div>
        ...
        <FooterWrapper>
          ...
          <div className="social-icons">
            ...
            <div className="icon">
              <a target="_blank" rel="noreferrer" href="https://www.tiktok.com/@yg_treasure_tiktok">
                <TiktokIcon />
              </a>
            </div>
            <div className="icon">
          ...
          <div className="credit">
            Made with 🖤, by a <a target="_blank" rel="noreferrer" href="https://github.com/khairahscorner">Teume</a>
          </div>
        </FooterWrapper>
      </div>
    );
